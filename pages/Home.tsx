...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="fade-in">
            ...
            <h1 className="w-full text-5xl sm:text-6xl md:text-7xl lg:text-[3.75rem] xl:text-[4.5rem] 2xl:text-[5.25rem] font-extrabold text-gray-900 leading-[0.95] mb-10 tracking-[-0.05em] font-heading">
              Experience <br className="lg:hidden" /><span className="text-brand-500">The Well.</span>
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                {/* Mobile: buttons stacked full width, then details row (original layout) */}
                <div className="lg:hidden">
                  <div className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 sm:space-x-6 mb-10">
                    <Link
                      to="/plan-your-visit"
                      className="px-12 py-6 bg-brand-500 text-white rounded-2xl font-black text-center shadow-lg shadow-brand-500/30 hover:bg-brand-600 hover:shadow-2xl hover:-translate-y-1.5 active:translate-y-0 transition-all duration-300"
                    >
                      Where to find us
                    </Link>
                    <Link
                      to="/sundays"
                      className="px-12 py-6 bg-brand-50 border-2 border-brand-500 text-brand-600 rounded-2xl font-black text-center shadow-lg shadow-brand-500/15 hover:bg-brand-100 hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300"
                    >
                      What's On
                    </Link>
                  </div>
                ...
                {/* Desktop: each button aligned directly above its detail */}
      ...
      {/* Planning a visit */}
      <section className="relative pb-28 md:pb-48 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
